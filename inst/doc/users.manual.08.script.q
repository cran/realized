...
#
path <- "d:/dev/"
eur.usd.05.2007 <- read.table(paste(path, "eurusd.csv.gz", sep=""), stringsAsFactors=F, sep=",")
usd.jpy.05.2007 <- read.table(paste(path, "usdjpy.csv.gz", sep=""), stringsAsFactors=F, sep=",")
eur.jpy.05.2007 <- read.table(paste(path, "eurjpy.csv.gz", sep=""), stringsAsFactors=F, sep=",")
